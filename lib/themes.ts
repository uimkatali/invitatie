...
export const THEME_CONFIGS: ThemeConfig[] = [
  ...
  { id: 'glass-snow', name: 'Ninsoare de sticla', particleShape: 'crystal', motionPattern: 'fall', material: 'glass', postProcessing: { bloom: false, vignette: true }, count: 16, starfield: false, colors: { bgDark: '#0a0f18', bgMid: '#1a2436', accentPrimary: '#e8f4ff', accentSecondary: '#a8c8e8', cream: '#ffffff' } },
